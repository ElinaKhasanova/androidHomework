...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, DataTransmit {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHeaderLogin = headerView.findViewById(R.id.tv_login_header);
        tvHeaderEmail = headerView.findViewById(R.id.tv_email_header);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            fragmentTransaction.replace(R.id.container, fragmentImport);
        } else if (id == R.id.nav_gallery) {
            fragmentTransaction.replace(R.id.container, fragmentGallery);
    ...
    public void transmit(String login, String mail) {
        fragmentProfile.save(login, mail);
